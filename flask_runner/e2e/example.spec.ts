...
/** this adds some extra config to the testing
 *  and ensures that electron has actually booted up
 *  when doing tests
 *  make a note of this and make sure to keep this in future stuff
 */
